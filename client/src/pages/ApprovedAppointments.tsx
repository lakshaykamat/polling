...
const ApprovedAppointments = () => {
  ...
  if (data) {
    const approvedAppointments = data.filter(
      (item: Appointment) => item.status === "Approved"
    );
    ...
    return (
      <Card className="max-w-3xl p-4 mx-auto my-7">
        ...
        {approvedAppointments.length === 0 ? (
          ...
          approvedAppointments.map((appointment: Appointment) => (
...
export const AppointmentCardStudent = ({
  ...
  return (
    <div className="p-4 mb-4 bg-green-300 border border-gray-200 rounded-lg shadow-lg">
